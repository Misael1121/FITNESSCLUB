      ...
      ON c.id_cliente = z.id_cliente  where  id_plan_cliente='$id_plan_cliente'  ") or die(mysqli_error());
                ...
                <div class="row">
                  <div class="col-md-4 col-lg-12 hide-section">
                    <a class="btn btn-primary btn-print" disabled="true" style="color:black; height:25%; width:50%; font-size: 25px " role="button">MEMBRESIA DE: <label style='color:white;  font-size: 25px '><?php echo $nombre_cliente; ?></label></a>
