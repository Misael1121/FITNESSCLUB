...
if (!empty($_FILES['imagen']['name'])) {
	...
	mysqli_query($con, "update empresa set empresa='$empresa',direccion='$direccion',telefono='$telefono',correo='$correo',por_dia='$por_dia',moneda='$moneda',simbolo_moneda='$simbolo_moneda',impuesto_diario='$impuesto_diario',impuesto_producto='$impuesto_producto',impuesto_planes='$impuesto_planes' where id_empresa='$id_empresa'") or die(mysqli_error());
