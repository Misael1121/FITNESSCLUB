  ...
  <div class="nav_menu">
    <nav>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="">
          <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
            <img src="img/pos.png" alt="">VENTAS

            <span class=" fa fa-angle-down"></span>
          </a>
          <ul class="dropdown-menu dropdown-usermenu pull-right">

            <li><a href="ventas.php"><i class="fa fa-money"></i>Ventas productos</a></li>
            <li><a href="plan_cliente.php"><i class="fa fa-money"></i> Ventas planes</a></li>
            <li><a href="venta_diaria.php"><i class="fa fa-money"></i> Ventas diaria</a></li>
