          ...
          <div class="box-body">
            ...
            <form method="post" action="planes_add.php" enctype="multipart/form-data" class="form-horizontal">
              <div class="row">
                <div class="col-md-3 btn-print">
                  <div class="form-group">
                    <label for="date">Tipo Plan</label>
                ...
                <div class="col-md-4 btn-print">
                  <div class="form-group">
                    <select class="form-control select2" name="tipo_tiempo" required>
                      <option value="dias">Diaro</option>
              ...
              <div class="row">
                ...
                <div class="col-md-4 btn-print">
                  <div class="form-group">
                    <input type="text" class="form-control pull-right" id="nombre_plan" name="nombre_plan" placeholder="Nombre " required>
                  </div>
                </div>
                <div class="col-md-4 btn-print">
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4 btn-print">
                  <div class="form-group">
                    <input type="text" class="form-control pull-right" id="numero_tiempo" name="numero_tiempo" placeholder="Tiempo " required>
                  </div>
                </div>
                <div class="col-md-4 btn-print">
                </div>
                        ...
                        <div class="modal-body" style="width: 100%; height: 100%;">
                          <form class="form-horizontal" method="post" action="plan_actualizar.php" enctype='multipart/form-data'>
                            ...
                            <div class="col-md-12 btn-print">
                              ...
                              <div class="form-group">
                                <label class="control-label col-lg-3" for="price">Tipo Plan</label><br>
                            ...
                            <div class="col-md-12 btn-print">
                              <div class="form-group">
                                <label class="control-label col-lg-3" for="file">Tiempo</label>
                                <div class="input-group col-md-8"">
